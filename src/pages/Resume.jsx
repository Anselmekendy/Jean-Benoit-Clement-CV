...
export default function Resume() {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = `${process.env.PUBLIC_URL}/Jean Benoit Clément CV.pdf`;
    link.download = 'Jean_Benoit_Clement_CV.pdf';
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-primary via-primary to-secondary text-white font-semibold text-lg rounded-full shadow-strong hover:shadow-[0_20px_60px_-12px_rgba(65,105,225,0.4)] transition-all duration-500 overflow-hidden transform hover:scale-105"
            >
              ...
              <div className="relative">
                <svg 
                  className={`w-6 h-6 transition-all duration-500 ${isHovering ? 'animate-bounce' : ''}`}
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                {/* Pulsing ring effect */}
                <div className="absolute inset-0 rounded-full bg-white/30 animate-ping opacity-0 group-hover:opacity-75" />
              </div>
              ...
              <svg 
                className={`w-5 h-5 relative transition-all duration-300 ${isHovering ? 'translate-x-1' : ''}`}
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
              ...
              <div className="absolute inset-0 rounded-full border-2 border-white/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </button>
          </div>
        </div>
